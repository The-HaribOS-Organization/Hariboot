...
config_file_t *parseConfigFile(EFI_SYSTEM_TABLE *SystemTable, UINT8 *configArray) {
    ...
    cFile->width = ((configArray[148] - 0x30) * 1000) + ((configArray[149] - 0x30) * 100) + ((configArray[150] - 0x30) * 10) + (configArray[151] - 0x30);
    cFile->height = ((configArray[153] - 0x30) * 1000) + ((configArray[154] - 0x30) * 100) + ((configArray[155] - 0x30) * 10) + (configArray[156] - 0x30);
